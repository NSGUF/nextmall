...
export default function MePage() {
    return (
        <Box
            style={{ background: "linear-gradient(to bottom,#fefcfd, #f2f3f7 100%)" }} minH="100vh" pb="80px">
            {/* 头部用户信息 */}
            <Box px={4} pt={6} pb={2}>
                <Flex align="center" justify="space-between">
                    <Flex align="center" gap={3}>
                        ...
                        <Box>
                            <Text fontWeight="bold" fontSize="xl">u2522</Text>
                        </Box>
                    </Flex>
                </Flex>
                {/* 资产栏 */}
            ...
            {/* 我的订单 */}
            <Box bg="white" mx={4} borderRadius="xl" p={4} mb={4} mt={8} boxShadow="2xs">
                <Flex justify="space-between" align="center" mb={2}>
                    <Text fontWeight="bold">我的订单</Text>
                    <Flex align="center" color="gray.500" fontSize="sm" cursor="pointer">
                        全部订单 <FiChevronRight />
                    </Flex>
                </Flex>
                <Grid templateColumns="repeat(5, 1fr)" gap={2} mt={4}>
                    <Flex direction="column" align="center" justify="center">
                        ...
                        <Text fontSize="xs" color="gray.500" mt={1}>待付款</Text>
                    </Flex>
                    <Flex direction="column" align="center" justify="center">
                        <FiGift size={24} />
                        <Text fontSize="xs" color="gray.500" mt={1}>待发货</Text>
                    </Flex>
                    <Flex direction="column" align="center" justify="center">
                        <FiTruck size={24} />
                        <Text fontSize="xs" color="gray.500" mt={1}>待收货</Text>
                    </Flex>
                    <Flex direction="column" align="center" justify="center">
                        <FiCheckCircle size={24} />
                        <Text fontSize="xs" color="gray.500" mt={1}>已完成</Text>
                    </Flex>
                    <Flex direction="column" align="center" justify="center">
                        <FiRefreshCw size={24} />
                        <Text fontSize="xs" color="gray.500" mt={1}>退款退货</Text>
                    </Flex>
                </Grid>
            </Box>
